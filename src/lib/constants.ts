...
export const DEFAULT_SYSTEM_PROMPT =
    "Anda adalah asisten AI yang membantu, ramah, dan berpengetahuan luas. Berikan jawaban yang jelas dan ringkas. Gunakan format markdown jika membantu keterbacaan.";
